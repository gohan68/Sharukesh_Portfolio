    ...
    <section id="home" className="min-h-screen flex flex-col justify-center px-6 md:px-12 relative overflow-hidden bg-white dark:bg-[#050505]">
      ...
      <div className="container mx-auto mt-20 md:mt-0 z-10">
        ...
        <div className="flex flex-col relative">
          <AnimatedText 
            text="SHARUKESH" 
            className="text-[12vw] leading-[0.8] font-display font-black text-neutral-900 dark:text-white tracking-tighter pr-4"
          />
        </div>
        ...
        <div className="mt-12 md:mt-24 flex flex-col md:flex-row justify-between items-end gap-8">
          ...
          >
            <p className="text-xl md:text-2xl text-neutral-700 dark:text-neutral-300 leading-relaxed font-light text-balance">
              <TypingSpan text="Fullstack Developer building scalable enterprise-grade SaaS platforms and modern web experiences with " />
              <TypingSpan text="Next.js" className="font-semibold text-black dark:text-white border-b border-black dark:border-white pb-0.5" />
              <TypingSpan text=" & " />
              <TypingSpan text="AI tools" className="font-semibold text-black dark:text-white border-b border-black dark:border-white pb-0.5" />
              <TypingSpan text="." />
            </p>
          </motion.div>
          ...
          >
            <a href="#projects" className="group relative px-8 py-4 bg-black dark:bg-white text-white dark:text-black rounded-full font-bold overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
