          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32">
              ...
              <motion.div
                ...
                className="hidden lg:block relative w-full max-w-[340px] aspect-[3/4] rounded-xl overflow-hidden bg-neutral-200 dark:bg-neutral-800 shadow-lg dark:shadow-neutral-900/50"
              >
          ...
          <div className="lg:col-span-8">
            <div className="space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-12 text-lg text-neutral-600 dark:text-neutral-400 leading-relaxed">
                ...
                >
                  I am a Fullstack Developer at DUTUK based in Chennai. My approach combines technical precision with a design-first mentality. I don't just write code; I architect digital ecosystems that are scalable, secure, and intuitive.
                </motion.p>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  Leveraging cutting-edge AI-augmented workflows, I deliver enterprise-grade applications at unprecedented speeds. My recent work includes complex B2B commerce engines and professional networking platforms built in weeks, not months.
                </motion.p>
              </div>
