      ...
      >
        <div className="animate-marquee whitespace-nowrap flex gap-16 md:gap-32 items-center">
          {allSkills.map((skill, index) => (
            <span key={`s1-${index}`} className="text-5xl md:text-8xl font-display font-black select-none cursor-default" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.3)', color: 'transparent' }}>
              {skill}
            </span>
          ))}
          {allSkills.map((skill, index) => (
            <span key={`s2-${index}`} className="text-5xl md:text-8xl font-display font-black select-none cursor-default" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.3)', color: 'transparent' }}>
              {skill}
            </span>
          ))}
        </div>
